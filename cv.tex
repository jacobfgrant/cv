...
\begin{multicols}{2}
        \begin{itemize}
        \footnotesize{
            \item \href{https://www.certmetrics.com/amazon/public/transcript.aspx?transcript=K2SWP3G22NF1QZ9G}{AWS Solutions Architect (Associate)}
            \item \href{https://}{Terraform}
        }
        \end{itemize}
\end{multicols}
