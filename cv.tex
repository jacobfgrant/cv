...
\titlespacing{\subsection}{0pt}{1pt}{0em}
...
\section{Objective} % Objective section
...
\begin{tabularx}{\linewidth}{
    ...
    \begin{itemize}[noitemsep,topsep=0pt]
        ...
        \item Proficiency/mastery of multiple languages, including \textbf{Python}, \textbf{R}, \textbf{Bash}, %\textbf{PowerShell} , etc.
        % Remove this and include PowerShell when ready
        etc.
    ...
    & %Extensive experience in s
    %System adminstration, homelabbing, networking, and endpoint management, using \textbf{MS Active Directory}, \textbf{VMware ESXi}, etc., with a focus on macOS management using \textbf{Apple MDM} and managing and contributing to open-source tools (e.g., \textbf{Munki}).
...
\begin{multicols}{2}
        ...
        \footnotesize{
            ...
            \item Financial \& Behavioral Economics
            \item Concepts in Computing with Data
            \item Structure \& Interpretation of Computer Programs
            \item Data Structures
            \item Computer Architecture (Machine Structures)
        }
        \end{itemize}
\end{multicols}
